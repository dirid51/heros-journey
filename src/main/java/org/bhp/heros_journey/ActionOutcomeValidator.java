...
public class ActionOutcomeValidator {
    ...
    /**
     * Legacy method for validating the old ActionOutcome record.
     * Use validateEligibility() and validateResult() separately instead.
     *
     * @deprecated Use validateEligibility() and validateResult() instead
     */
